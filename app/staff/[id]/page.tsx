          ...
          <>
                      ...
                      <div>
                        ...
                        <p>
                          {selectedStaff.lastLogin
                            ? format(new Date(selectedStaff.lastLogin), "PPpp")
                            : "Never"}
                        </p>
                      </div>
                      <div>
                        ...
                        <p>
                          {format(new Date(selectedStaff.createdAt), "PPpp")}
                        </p>
                      </div>
                    </div>
                  </div>
            ...
            <Tabs defaultValue="activity">
              ...
              <TabsContent value="activity" className="mt-4">
                <StaffActivityLogs staffId={selectedStaff.id} />
              </TabsContent>
              <TabsContent value="permissions" className="mt-4">
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Permissions granted to {selectedStaff.name} through the{" "}
                      {getRoleName(selectedStaff.role)} role
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
